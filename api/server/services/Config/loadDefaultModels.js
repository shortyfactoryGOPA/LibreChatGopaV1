...
async function loadDefaultModels(req) {
  try {
    ...
    const [openAI, anthropic, azureOpenAI, assistants, google, bedrock] = await Promise.all([
    ...
    // azureAssistants shares the same model pool as azureOpenAI — no separate API call needed
    const azureAssistants = isEnabled(EModelEndpoint.azureAssistants) ? azureOpenAI : [];
